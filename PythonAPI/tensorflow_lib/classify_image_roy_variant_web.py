...
def run_inference_on_image(image, node_lookup, config):
    ...
    with tf.Session() as sess:
        ...
        for node_id in top_k:
            ...
            top_5_container.append({"label": human_string, "score": score})

    return top_5_container


class roy_config:
    relative_path = 'data/imagenet'
    model_dir = system.create_abs_path(relative_path)
...
class TfHandler(object):
    ...
    def tf_inference(self, image_path):
        return run_inference_on_image(image_path, self.node_lookup, self.config)


if __name__ == '__main__':
    image_path = "/home/furaoing/roy_tensorflow_cv/face++test_ws/debug_test/7.jpg"
    #image_path2 = "/home/furaoing/images_test/test33.jpg"

    test_tf = TfHandler()
    test_tf.tf_inference(image_path)
